...
public class ProbarPolimorfismoFigura {
    public static void main(String[] args) {
        ...
        System.out.println("Desde f1 solo se ven los atributos de Figura x: " + f1.getX() + "y" + f1.getY());
        Triangulo t1 = (Triangulo) f1;
        System.out.println("Desde t1 solo se ven los atributos de Triangulo x: " + t1.getX() + "y" + t1.getY() + "base" + t1.getBase() + "altura" + t1.getAltura());
